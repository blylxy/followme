...
<html class="x-admin-sm">
    <head>
        <meta charset="UTF-8">
        <title>{{ $site_name['value'] }} - 管理后台</title>
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./home">{{ $site_name['value'] }} - 管理后台</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav left fast-add" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('最大化','http://{{ $domain['value'] }}','','',true)">
                                <i class="iconfont">&#xe6a2;</i>弹出最大化</a></dd>
                        <dd>
                            <a onclick="xadmin.open('弹出自动宽高','http://{{ $domain['value'] }}')">
                                <i class="iconfont">&#xe6a8;</i>弹出自动宽高</a></dd>
                        <dd>
                            <a onclick="xadmin.open('弹出指定宽高','http://{{ $domain['value'] }}',500,300)">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('个人信息','./adminer')">管理员信息</a></dd>
                        <dd>
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('站点配置','baseinfo')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>站点配置</cite></a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('用户列表','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('用户分组','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户分组</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="景区管理">&#xe6b4;</i>
                            <cite>景区管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('景点列表','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>景点列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('景点分组','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>景点分组</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('标签管理','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>标签管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('关联特产','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>关联特产</cite></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('关联游记','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>关联游记</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('关联领队','unicode.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>关联领队</cite></a>
                            </li>
                        </ul>
